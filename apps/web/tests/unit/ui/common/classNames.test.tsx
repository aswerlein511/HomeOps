...
describe('classNames', () => {
    ...
    it('ignores undefined values', () => {
        expect(classNames('button', undefined, 'primary')).toBe('button primary');
    });

    it('ignores null values', () => {
        expect(classNames('button', null, 'primary')).toBe('button primary');
    });

    it('ignores false values', () => {
        expect(classNames('button', false, 'primary')).toBe('button primary');
    });
