...
describe('Metric', () => {
    it('renders label', () => {
        render(<Metric label='CPU' value='31%' />);
    ...
    it('renders numeric value', () => {
        render(<Metric label='Temperature' value={55} />);

        expect(screen.getByText('55')).toBeInTheDocument();
    });

    it('renders zero', () => {
        render(<Metric label='Usage' value={0} />);

        expect(screen.getByText('0')).toBeInTheDocument();
    });

    it('renders long value', () => {
        render(<Metric label='Model' value='Intel Core Ultra 9 285K' />);
